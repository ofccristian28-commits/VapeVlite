 ...
 public abstract class Module
{
    ...
    private ArrayList<StringValue> strings;
    ...
    public Module(final String name, final int key, final Category category) {
        ...
        this.strings = new ArrayList<StringValue>();
    }
    ...
    public ArrayList<StringValue> getStrings() { return this.strings; }
    public void addString(final StringValue value) { this.strings.add(value); }
    ...
    /** Optional packet hook. Return null to consume/delay the packet. */
    public Object onPacketReceive(final io.netty.channel.ChannelHandlerContext ctx, final Object packet) {
        return packet;
    }
}
